...
namespace Marketing
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connection = Environment.GetEnvironmentVariable("SQL_CONNECTIONSTRING") ?? Configuration["ConnectionStrings:MarketingContext"];
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Marketing V1");
                });
            }
